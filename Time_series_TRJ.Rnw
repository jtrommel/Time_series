...
p2 <- ggplot(data=period.form) + 
  ...
  labs(title="Periodic signal for \ndifferent periods (loess)") +
  JT.theme
@

<<label=JTperiodcompare,fig=TRUE,include=FALSE, echo=FALSE>>=
grid.arrange(p1,p2,nrow=2)
@

\begin{marginfigure}[-7cm]
\includegraphics[width=1\textwidth]{TS-JTperiodcompare}
\caption{}
\label{fig:JTperiodcompare}
\setfloatalignment{b}
\end{marginfigure}
